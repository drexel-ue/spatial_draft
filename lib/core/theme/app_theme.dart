...
class AppThemeTokens {
  ...
  static AppThemeTokens light() {
    ...
    return AppThemeTokens(
      ...
      gridLineMajor: const Color(0xFFCBD5E1),
      gridLineMinor: const Color(0xFFE2E8F0),
  ...
  static AppThemeTokens dark() {
    ...
    return AppThemeTokens(
      ...
      gridLineMajor: const Color(0xFF2A2E37),
      gridLineMinor: const Color(0xFF1E2128),
  ...
  static AppThemeTokens blueprint() {
    ...
    return AppThemeTokens(
      ...
      gridLineMajor: const Color(0xFF1E40AF),
      gridLineMinor: const Color(0xFF172554),
      reticleColor: const Color(0xFF38BDF8),
      headingStyle: baseHeading,
      bodyStyle: baseBody,
      monoStyle: baseMono,
